...
public class Member {
	...
	public Member(int memberId2, String memberName2, String memberAddress2, Date accountOpenDate2,
			String memberShipType2, double feesPaid2, int maxBookAllowed2, double penaltyAmount2) {
		// TODO Auto-generated constructor stub
	}
